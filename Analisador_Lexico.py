...
# Essa codificacao e usada no arquivo de saida que contem os
...
class AnalisadorLexico():
    ...
    # Metodo que verifica se a entrada e um delimitador
    ...
    # Metodo que especifica qual dos tokens delimitadores e a entrada
    ...
    # Metodo que verifica se a entrada e uma letra
    ...
    # Metodo que verifica se a entrada e um digito
    ...
    # Metodo que verifica se a entrada e um simbolo ascii
    ...
    # Metodo que verifica se a entrada e um operador
    ...
    # Metodo que especifica qual dos tokens operadores e a entrada
    ...
    # Metodo que verifica se a entrada e uma palavra reservada
    ...
    # Metodo que especifica qual dos tokens palavras reservadas e a entrada
    ...
    def analisa(self):
        ...
        while linha_programa:
            ...
            while i < tamanho_linha:  # Percorre os caracteres da linha
                ...
                # So posso pegar o caractere_seguinte se ele existe na linha
                if ((i + 1) < tamanho_linha):
                    caractere_seguinte = linha_programa[i + 1]
                    # ===================================================================================
                # Verifica se o caracter e um delimitador - OK
                if (self.ehDelimitador(caracter_atual)):
                    arquivo_saida.write(self.qualTokenDelimitador(caracter_atual) + '_' + caracter_atual + '->' + str(
                        numero_linha) + '\n')
                # ===================================================================================
                ...
                # Consumindo comentarios de bloco - OK
                    ...
                    cont = True  # Variavel que impedira o loop a seguir de continuar caso
                    ...
                    # podera indicar o comeco do erro
                ...
                # Verificando se o elemento eh um operador
                    ...
                    arquivo_saida.write(self.qualTokenOperador(
                        caracter_atual + caractere_seguinte) + '_' + caracter_atual + caractere_seguinte + '->' + str(
                        numero_linha) + '\n')
                    i += 1
                elif self.ehOperador(caracter_atual):
                    arquivo_saida.write(
                        self.qualTokenOperador(caracter_atual) + '_' + caracter_atual + '->' + str(numero_linha) + '\n')

                # ===================================================================================
                # Verificando se o elemento em questao e caractere constante - OK
                # string.punctuation[6] retorna o simbolo - ' - que representa o inicio do caractere constante
                    ...
                    if (linha_programa[i + 1] == '\n') or (not (string.punctuation[6] in linha_programa[i + 1:])):
                        ...
                        i = tamanho_linha
                    elif self.ehSimbolo(linha_programa[i + 1]) and linha_programa[i + 1] != string.punctuation[6] and \
                ...
                # ===================================================================================
                # Verificando se o elemento em questao e cadeia constante - OK
                # string.punctuation[1] retorna o simbolo - " - que representa o inicio da cadeia constante
                    ...
                    # Se a linha so contem uma ocorrencia de ", significa que a string nao foi fechada
                ...
                # ===================================================================================
                # Verificando se o elemento em questao e um numero - OK
                ...
                # Verificando identificadores ou palavras reservadas - OK
                    ...
                    while i < tamanho_linha:
                        ...
                        if (self.ehLetra(caracter_atual) or self.ehDigito(caracter_atual) or caracter_atual == '_'):
                            string_temp += caracter_atual
                        elif (self.ehDelimitador(
                                caracter_atual) or caracter_atual == ' ' or caracter_atual == '\t' or caracter_atual == '\r'):
                            i -= 1  # Preciso voltar um elemento da linha para que o delimitador seja reconhecido no momento certo
                            break
                        elif (caractere_seguinte != None and self.ehOperador(
                                caracter_atual + caractere_seguinte)) or self.ehOperador(caracter_atual):
                            i -= 1
                            break
                        elif caracter_atual != '\n':
                            arquivo_saida.write(
                    ...
                    if (algum_erro):
                        while (i + 1 < tamanho_linha):
                            i += 1
                            caracter_atual = linha_programa[i]
                            if self.ehDelimitador(
                                    caracter_atual) or caracter_atual == ' ' or caracter_atual == '\t' or caracter_atual == '\r' or caracter_atual == '/':
                                i -= 1  # Preciso voltar um elemento da linha para que o delimitador seja reconhecido no momento certo
                                break
                    else:  # Se nao houver erros basta verificar se o elemento e palavra reservada tambem
                        if (self.ehReservada(string_temp)):
                            arquivo_saida.write(self.qualTokenReservada(string_temp) + '_' + string_temp + '->' + str(
                                numero_linha) + '\n')
                        else:
                ...
                # por aparecerem constantemente no codigo
